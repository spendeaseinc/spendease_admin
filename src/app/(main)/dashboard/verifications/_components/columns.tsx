...
export const columns: ColumnDef<VerificationRequest>[] = [
    {
        ...
        header: "ID",
        cell: ({ row }) => <div className="text-muted-foreground font-mono text-xs">{row.getValue("reference") as string}</div>,
    },
    {
        accessorKey: "user",
        header: "Customer",
    ...
    },
    {
        ...
        header: "Risk",
        cell: ({ row }) => {
            const risk = row.getValue("risk_level") as VerificationRiskLevel;
